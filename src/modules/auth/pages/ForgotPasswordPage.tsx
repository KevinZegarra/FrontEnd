        ...
        >
          <Stack spacing={3.5} alignItems="center">
            ...
            <Stack spacing={1.5} alignItems="center" sx={{ textAlign: 'center' }}>
              ...
              <Typography variant="h2" sx={{ color: 'secondary.main', fontWeight: 800, fontSize: { xs: '1.35rem', md: '1.5rem' } }}>
                Recuperar contraseña
              </Typography>

              <Typography variant="body2" sx={{ color: 'text.secondary', fontSize: '0.875rem', maxWidth: 340 }}>
                {isSubmitted
